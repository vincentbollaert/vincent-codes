...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/PR0u5KaXzF)
...
```sh
npx nx serve vincent-codes
```

To create a production bundle:

```sh
npx nx build vincent-codes
```

To see all available targets to run for a project, run:

```sh
npx nx show project vincent-codes
```
